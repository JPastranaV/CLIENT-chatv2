...
public class Upload implements Runnable{
    ...
    public Upload(String addr, int port, File filepath, UI_Chat frame){
        super();
        try {
    ...
    public void run() {
        try {       
            ...
            Out.flush();
            //client.insertText("[Applcation > Me] : File upload complete\n");
             //append("[Applcation > Me] : File upload complete\n");
